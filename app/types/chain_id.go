...
import (
	...
	tendermintTypes "github.com/fibonacci-chain/fbc/libs/tendermint/types"
)
...
const mainnetChainId = "fbc-1230"
const testnetChainId = "fbc-3021"

const JupiterBeforeMainNetChainId = 1230
const JupiterBeforeTestNetChainId = 3021

const JupiterMainNetChainId = 12306
const JupiterTestNetChainId = 12307
...
func IsJupiterBeforeMainNetChainId(chainID *big.Int) bool {
	return chainID.Int64() == JupiterBeforeMainNetChainId
}

func IsJupiterBeforeTestNetChainId(chainID *big.Int) bool {
	return chainID.Int64() == JupiterBeforeTestNetChainId
}
