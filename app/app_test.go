...
import (
	...
	cosmossdk "github.com/fibonacci-chain/fbc/libs/cosmos-sdk/types"
	...
	tendertypes "github.com/fibonacci-chain/fbc/libs/tendermint/types"
	"github.com/fibonacci-chain/fbc/x/distribution/keeper"
	...
	abcitypes "github.com/fibonacci-chain/fbc/libs/tendermint/abci/types"
...
func (suite *FakeBlockTxTestSuite) TestFakeBlockTx() {
	testCases := []struct {
		...
		},
		{
			...
			5, //insufficient funds: insufficient funds to pay for fees; 890.000000000000000000fibo < 1000000000000000000.000000000000000000fibo
			0,
		},
		{
