...
import (
	...
	"github.com/fibonacci-chain/fbc/x/vmbridge"

	ica "github.com/fibonacci-chain/fbc/libs/ibc-go/modules/apps/27-interchain-accounts"
	...
	"github.com/fibonacci-chain/fbc/app/utils/appstatus"
	...
	fbchain "github.com/fibonacci-chain/fbc/app/types"
	...
	"github.com/fibonacci-chain/fbc/libs/ibc-go/modules/core/02-client/client"
	...
	sm "github.com/fibonacci-chain/fbc/libs/tendermint/state"
...
func NewFBChainApp(
	...
	logger.Info("Starting "+system.ChainName,
		...
		"Veneus5Height", tmtypes.GetVenus5Height(),
