...
import (
	...
	"github.com/fibonacci-chain/fbc/app/rpc/backend"
	"github.com/fibonacci-chain/fbc/app/rpc/monitor"
	"github.com/fibonacci-chain/fbc/app/rpc/namespaces/eth/simulation"
	rpctypes "github.com/fibonacci-chain/fbc/app/rpc/types"
	"github.com/fibonacci-chain/fbc/app/types"
	ethermint "github.com/fibonacci-chain/fbc/app/types"
	"github.com/fibonacci-chain/fbc/app/utils"
	clientcontext "github.com/fibonacci-chain/fbc/libs/cosmos-sdk/client/context"
	...
	cmserver "github.com/fibonacci-chain/fbc/libs/cosmos-sdk/server"
	...
	authclient "github.com/fibonacci-chain/fbc/libs/cosmos-sdk/x/auth/client/utils"
	...
	"github.com/fibonacci-chain/fbc/libs/tendermint/crypto/merkle"
...
func (api *PublicEthereumAPI) ChainId() (hexutil.Uint, error) { // nolint
	...
	networkId := api.clientCtx.ChainID

	if tmtypes.HigherThanJupiter(height) {
		if types.IsMainNetChainID(networkId) {
			chainID := big.NewInt(types.JupiterMainNetChainId)
			return hexutil.Uint(uint(chainID.Uint64())), nil
		} else if types.IsTestNetChainID(networkId) {
...
func (api *PublicEthereumAPI) GasPrice() *hexutil.Big {
	...
	if appconfig.GetFecConfig().GetDynamicGpMode() != tmtypes.MinimalGpMode {
		...
		if appconfig.GetFecConfig().GetDynamicGpCoefficient() > 1 {
