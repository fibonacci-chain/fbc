...
import (
	...
	cosmos_context "github.com/fibonacci-chain/fbc/libs/cosmos-sdk/client/context"
	...
	"github.com/fibonacci-chain/fbc/app/rpc/types"
...
func (suite *RPCTestSuite) TestEth_GetBalance() {
	// initial balance of hexAddr2 is 1000000000fibo in test.sh
