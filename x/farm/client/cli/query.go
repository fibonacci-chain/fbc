...
import (
	...
	client "github.com/fibonacci-chain/fbc/libs/cosmos-sdk/client/flags"
...
Example:
$ %s query farm rewards pool-eth-xxb fb1cftp8q8g4aa65nw9s5trwexe77d9t6cr8ndu02
`,
				version.ClientName,
			),
		),
...
Example:
$ %s query farm account fb1cftp8q8g4aa65nw9s5trwexe77d9t6cr8ndu02
`,
				version.ClientName,
			),
		),
...
Example:
$ %s query farm lock-info pool-eth-xxb fb1cftp8q8g4aa65nw9s5trwexe77d9t6cr8ndu02 
`,
				version.ClientName,
			),
		),
