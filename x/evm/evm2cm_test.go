...
import (
	...
	etypes "github.com/fibonacci-chain/fbc/x/evm/types"
...
func TestDecodeParam(t *testing.T) {
	testcases := []struct {
		...
		{
			// {"module": "staking","function": "deposit","data": "{\"delegator_address\": \"0xb2910e22bb23d129c02d122b77b462ceb0e89db9\",\"quantity\": {\"denom\": \"fibo\",\"amount\": \"1\"}}"}
			...
			fnCheck: func(ctm []byte, err error) {
				require.NoError(t, err)
				tmpExpect := "okt"
				data := fmt.Sprintf(`{"module": "staking","function": "deposit","data": "{\"delegator_address\": \"0xb2910e22bb23d129c02d122b77b462ceb0e89db9\",\"quantity\": {\"denom\": \"%s\",\"amount\": \"1\"}}"}`, tmpExpect)
