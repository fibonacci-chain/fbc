...
const (
 ...
 IsAdded:				true
 DistributorAddrs:
						fb1qqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqpvmzvy
						fb1qqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqpu60h3k`
 ...
 IsAdded:				true
 ContractList:
						Address: fb1qqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqpvmzvy
Method List:
Sign: 0x11111111Extra: TEST1
Sign: 0x22222222Extra: TEST2
						Address: fb1qqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqpu60h3k
Method List:
...
func (suite *ProposalTestSuite) TestProposal_ManageSysContractAddressProposal() {
 ...
 ContractAddr:          fb1qqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqpvmzvy
 IsAdded:				true`
