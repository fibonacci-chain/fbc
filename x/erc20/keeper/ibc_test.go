...
import (
	...
	erc20Keeper "github.com/fibonacci-chain/fbc/x/erc20/keeper"
	"github.com/fibonacci-chain/fbc/x/erc20/types"
...
func (suite *KeeperTestSuite) TestIbcTransferVouchers() {
	...
	testCases := []struct {
		...
		//	addr1Bech.String(),
		//	"to",
		//	sdk.NewCoins(sdk.NewCoin(sdk.DefaultBondDenom, sdk.NewInt(fibo000000000))),
		//	func() {},
		//	errors.New("0aphoton is smaller than 000000000aphoton: insufficient funds"),
		//	func() {},
		//},
		//{
		...
		//	addr1Bech.String(),
		//	"to",
		//	sdk.NewCoins(sdk.NewCoin(sdk.DefaultBondDenom, sdk.NewInt(000000000))),
		//	func() {
		//		// Mint Coin to user and module
		//		suite.MintCoins(addr1Bech, sdk.NewCoins(sdk.NewCoin(sdk.DefaultBondDenom, sdk.NewInt(000000000))))
		...
		//		suite.Require().Equal(sdk.NewInt(000000000), evmCoin.Amount)
		//	},
		//	nil,
		//	func() {
