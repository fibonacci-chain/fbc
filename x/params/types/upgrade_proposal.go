...
import (
	...
	sdkgovtypes "github.com/fibonacci-chain/fbc/libs/cosmos-sdk/x/gov/types"
...
const (
	ProposalTypeUpgrade = "fBCUpgrade"
	UpgradeRouterKey    = "fbcUpgrade"

	QueryUpgrade = "fbcUpgrade"
...
func init() {
	...
	govtypes.RegisterProposalTypeCodec(UpgradeProposal{}, "fbexchain/params/UpgradeProposal")
}
