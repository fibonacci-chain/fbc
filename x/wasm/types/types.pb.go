...
type Model struct {
	...
	Key github_com_tendermint_tendermint_libs_bytes.HexBytes `protobuf:"bytes,1,opt,name=key,proto3,casttype=github.com/fibonacci-chain/fbc/libs/tendermint/libs/bytes.HexBytes" json:"key,omitempty"`
