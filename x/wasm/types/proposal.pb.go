...
type InstantiateContractProposal struct {
	...
	Funds github_com_cosmos_cosmos_sdk_types.CoinAdapters `protobuf:"bytes,8,rep,name=funds,proto3,castrepeated=github.com/fibonacci-chain/fbc/libs/cosmos-sdk/types.Coins" json:"funds"`
}
