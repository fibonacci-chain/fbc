...
import (
	...
	distributiontypes "github.com/fibonacci-chain/fbc/libs/cosmos-sdk/x/distribution/types"
...
func sdkToDelegations(ctx sdk.Context, keeper types.StakingKeeper, delegations []stakingtypes.Delegation) (wasmvmtypes.Delegations, error) {
	...
	for i, d := range delegations {
		...
		// https://github.com/fibonacci-chain/fbc/libs/cosmos-sdk/blob/v0.38.3/x/staking/keeper/querier.go#L404
...
func sdkToFullDelegation(ctx sdk.Context, keeper types.StakingKeeper, distKeeper types.DistributionKeeper, delegation stakingtypes.Delegation) (*wasmvmtypes.FullDelegation, error) {
	...
	// https://github.com/fibonacci-chain/fbc/issues/282
...
// https://github.com/fibonacci-chain/fbc/libs/cosmos-sdk/issues/7466 is merged
