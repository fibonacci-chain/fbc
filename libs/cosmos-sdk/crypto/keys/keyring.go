...
import (
	...
	tmcrypto "github.com/fibonacci-chain/fbc/libs/tendermint/crypto"
	cryptoAmino "github.com/fibonacci-chain/fbc/libs/tendermint/crypto/encoding/amino"
	"github.com/tendermint/crypto/bcrypt"

	"github.com/fibonacci-chain/fbc/libs/cosmos-sdk/client/input"
	"github.com/fibonacci-chain/fbc/libs/cosmos-sdk/crypto/keys/keyerror"
	"github.com/fibonacci-chain/fbc/libs/cosmos-sdk/crypto/keys/mintkey"
...
// CreateMnemonicWithHDPath generates a new key and persists it to storage, encrypted
// using the provided password. It returns the generated mnemonic and the key Info.
// An error is returned if it fails to generate a key for the given algo type,
// or if another key is already stored under the same name.
func (kb keyringKeybase) CreateMnemonicWithHDPath(
	name string, language Language, passwd string, algo SigningAlgo, mnemonicInput string, hdPath string,
) (info Info, mnemonic string, err error) {

	return kb.base.CreateMnemonicWithHDPath(kb, name, language, passwd, algo, mnemonicInput, hdPath)
}
