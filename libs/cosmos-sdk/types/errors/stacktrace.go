...
func trimInternal(st errors.StackTrace) errors.StackTrace {
	...
	for matchesFunc(st[0],
		...
		"github.com/fibonacci-chain/fbc/libs/cosmos-sdk/types/errors.Wrap",
		"github.com/fibonacci-chain/fbc/libs/cosmos-sdk/types/errors.Wrapf",
		"github.com/fibonacci-chain/fbc/libs/cosmos-sdk/types/errors.WithType",
