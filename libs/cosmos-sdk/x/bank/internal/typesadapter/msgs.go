...
import (
	...
	okc_types "github.com/fibonacci-chain/fbc/libs/cosmos-sdk/x/bank/internal/types"
)
...
func (m *MsgSend) RulesFilter() (sdk.Msg, error) {
	...
	for i, amount := range msgSend.Amount {
		if amount.Denom == sdk.DefaultIbcWei {
			...
			return nil, sdkerrors.Wrap(sdkerrors.ErrInvalidCoins, "MsgSend not support fibo denom")
		}
	}
	return &msgSend, nil
}
