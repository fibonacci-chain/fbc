...
func TestParseMsgWrapper(t *testing.T) {
	testcases := []struct {
		...
		{
			input: `{"type": "fbexchain/staking/MsgDeposit","value": {"delegator_address": "0x4375D630687C83471829227b5C1Ea92217FD6265","quantity": {"denom": "fibo","amount": "1"}}}`,
			fnCheck: func(ret *MsgWrapper, err error) {
				require.NoError(t, err)
				require.Equal(t, "fbexchain/staking/MsgDeposit", ret.Name)
				require.Equal(t, "{\"delegator_address\": \"0x4375D630687C83471829227b5C1Ea92217FD6265\",\"quantity\": {\"denom\": \"fibo\",\"amount\": \"1\"}}", string(ret.Data))
			},
		},
		{
			input: `{"type": "fbexchain/staking/MsgWithdraw","value": {"delegator_address": "0x4375D630687C83471829227b5C1Ea92217FD6265","quantity": {"denom": "fibo","amount": "1"}}}`,
			fnCheck: func(ret *MsgWrapper, err error) {
				require.NoError(t, err)
