...
import (
	...
	blockindex "github.com/fibonacci-chain/fbc/libs/tendermint/state/indexer"
	bloxkindexnull "github.com/fibonacci-chain/fbc/libs/tendermint/state/indexer/block/null"

	"github.com/fibonacci-chain/fbc/libs/tendermint/global"
	...
	bcv0 "github.com/fibonacci-chain/fbc/libs/tendermint/blockchain/v0"
	bcv1 "github.com/fibonacci-chain/fbc/libs/tendermint/blockchain/v1"
	bcv2 "github.com/fibonacci-chain/fbc/libs/tendermint/blockchain/v2"
	cfg "github.com/fibonacci-chain/fbc/libs/tendermint/config"
	"github.com/fibonacci-chain/fbc/libs/tendermint/consensus"
	cs "github.com/fibonacci-chain/fbc/libs/tendermint/consensus"
	"github.com/fibonacci-chain/fbc/libs/tendermint/crypto"
	"github.com/fibonacci-chain/fbc/libs/tendermint/evidence"
	...
	"github.com/fibonacci-chain/fbc/libs/tendermint/libs/service"
	mempl "github.com/fibonacci-chain/fbc/libs/tendermint/mempool"
	"github.com/fibonacci-chain/fbc/libs/tendermint/p2p"
	"github.com/fibonacci-chain/fbc/libs/tendermint/p2p/pex"
	"github.com/fibonacci-chain/fbc/libs/tendermint/privval"
	"github.com/fibonacci-chain/fbc/libs/tendermint/proxy"
	rpccore "github.com/fibonacci-chain/fbc/libs/tendermint/rpc/core"
	ctypes "github.com/fibonacci-chain/fbc/libs/tendermint/rpc/core/types"
	grpccore "github.com/fibonacci-chain/fbc/libs/tendermint/rpc/grpc"
	rpcserver "github.com/fibonacci-chain/fbc/libs/tendermint/rpc/jsonrpc/server"
	sm "github.com/fibonacci-chain/fbc/libs/tendermint/state"
	blockindexer "github.com/fibonacci-chain/fbc/libs/tendermint/state/indexer/block/kv"
	"github.com/fibonacci-chain/fbc/libs/tendermint/state/txindex"
	"github.com/fibonacci-chain/fbc/libs/tendermint/state/txindex/kv"
	"github.com/fibonacci-chain/fbc/libs/tendermint/state/txindex/null"
	"github.com/fibonacci-chain/fbc/libs/tendermint/store"
	"github.com/fibonacci-chain/fbc/libs/tendermint/types"
	tmtime "github.com/fibonacci-chain/fbc/libs/tendermint/types/time"
	"github.com/fibonacci-chain/fbc/libs/tendermint/version"
)
...
func createPEXReactorAndAddToSwitch(addrBook pex.AddrBook, config *cfg.Config,
	...
	pexReactor := pex.NewReactor(addrBook,
		&pex.ReactorConfig{
			...
			// https://github.com/fibonacci-chain/fbc/libs/tendermint/issues/3523
...
func (n *Node) startRPC() ([]net.Listener, error) {
	...
	// See https://github.com/fibonacci-chain/fbc/libs/tendermint/issues/3435
